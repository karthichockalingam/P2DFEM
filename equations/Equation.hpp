...
public:
   ...
   virtual void Update(const BlockVector &x, const Coefficient &j, const real_t &dt) = 0;
   virtual void Update(const BlockVector &x, const GridFunctionCoefficient &u, const Coefficient &j, const real_t &dt) = 0;
